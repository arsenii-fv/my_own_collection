...
``` bash
(at_venv) arsen@lite:~/08-ansible/08_ansible_06/ansible$ ansible-playbook site.yml -v
...
Using /home/arsen/.ansible.cfg as config file
...
ok: [localhost] => {"File is change": true, "changed": false}

PLAY RECAP ******************************************************************************************************************************
localhost                  : ok=2    changed=0    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0   

(at_venv) arsen@lite:~/08-ansible/08_ansible_06/ansible$ 
```
